...
function AdminProfile() {
  ...
  const [profile, setProfile] = useState({
    ...
    address: "789 Admin Tower, City, State 12345",
    adminId: "ADM-001",
    role: "Super Admin",
        ...
        <div className="space-y-3">
          ...
          <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
            ...
            <input
              ...
              onChange={(e) => handlePreferenceChange("userReports", e.target.checked)}
              className="w-5 h-5 text-purple-600 rounded focus:ring-purple-500"
            />
          </label>
        </div>
      ...
      <div>
        ...
        <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-purple-800">2FA is required for admin accounts</p>
              <p className="text-sm text-purple-600">Your account is secured with 2FA</p>
            </div>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Profile Header */}
      <div className="bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-2xl p-8 mb-6">
        <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-start">
              <span className="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">🛡️ {profile.role}</span>
              <span className="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">🆔 {profile.adminId}</span>
              <span className="px-3 py-1 bg-white bg-opacity-20 rounded-full text-sm">🏢 {profile.department}</span>
            </div>
          </div>
